...
class AccountBalanceTest {
	@Test
	fun empty() {
		val balance = AccountBalance.EMPTY

		assertThat(balance.bchAvailable).isEqualTo(0f)
		assertThat(balance.bchBalance).isEqualTo(0f)
		assertThat(balance.bchReserved).isEqualTo(0f)
		assertThat(balance.bchBtcFee).isEqualTo(0f)
		assertThat(balance.bchEurFee).isEqualTo(0f)
		assertThat(balance.bchUsdFee).isEqualTo(0f)
		assertThat(balance.btcAvailable).isEqualTo(0f)
		assertThat(balance.btcBalance).isEqualTo(0f)
		assertThat(balance.btcReserved).isEqualTo(0f)
		assertThat(balance.btcEurFee).isEqualTo(0f)
		assertThat(balance.btcUsdFee).isEqualTo(0f)
		assertThat(balance.ethAvailable).isEqualTo(0f)
		assertThat(balance.ethBalance).isEqualTo(0f)
		assertThat(balance.ethReserved).isEqualTo(0f)
		assertThat(balance.ethBtcFee).isEqualTo(0f)
		assertThat(balance.ethEurFee).isEqualTo(0f)
		assertThat(balance.ethUsdFee).isEqualTo(0f)
		assertThat(balance.eurAvailable).isEqualTo(0f)
		assertThat(balance.eurBalance).isEqualTo(0f)
		assertThat(balance.eurReserved).isEqualTo(0f)
		assertThat(balance.eurUsdFee).isEqualTo(0f)
		assertThat(balance.ltcAvailable).isEqualTo(0f)
		assertThat(balance.ltcBalance).isEqualTo(0f)
		assertThat(balance.ltcReserved).isEqualTo(0f)
		assertThat(balance.ltcBtcFee).isEqualTo(0f)
		assertThat(balance.ltcEurFee).isEqualTo(0f)
		assertThat(balance.ltcUsdFee).isEqualTo(0f)
		assertThat(balance.usdAvailable).isEqualTo(0f)
		assertThat(balance.usdBalance).isEqualTo(0f)
		assertThat(balance.usdReserved).isEqualTo(0f)
		assertThat(balance.xrpAvailable).isEqualTo(0f)
		assertThat(balance.xrpBalance).isEqualTo(0f)
		assertThat(balance.xrpReserved).isEqualTo(0f)
		assertThat(balance.xrpBtcFee).isEqualTo(0f)
		assertThat(balance.xrpEurFee).isEqualTo(0f)
		assertThat(balance.xrpUsdFee).isEqualTo(0f)

		assertThat(balance.available).containsOnly(
			MapEntry.entry("BCH", 0f),
			MapEntry.entry("BTC", 0f),
			MapEntry.entry("ETH", 0f),
			MapEntry.entry("EUR", 0f),
			MapEntry.entry("LTC", 0f),
			MapEntry.entry("USD", 0f),
			MapEntry.entry("XRP", 0f)
		)
		...
		assertThat(balance.fees).containsOnly(
			MapEntry.entry("BCHBTC", 0f),
			MapEntry.entry("BCHEUR", 0f),
			MapEntry.entry("BCHUSD", 0f),
			MapEntry.entry("BTCEUR", 0f),
			MapEntry.entry("BTCUSD", 0f),
			MapEntry.entry("ETHBTC", 0f),
			MapEntry.entry("ETHEUR", 0f),
			MapEntry.entry("ETHUSD", 0f),
			MapEntry.entry("EURUSD", 0f),
			MapEntry.entry("LTCBTC", 0f),
			MapEntry.entry("LTCEUR", 0f),
			MapEntry.entry("LTCUSD", 0f),
			MapEntry.entry("XRPBTC", 0f),
			MapEntry.entry("XRPEUR", 0f),
			MapEntry.entry("XRPUSD", 0f)
		)
